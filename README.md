...
[![Rules](https://img.shields.io/badge/rules-1,431-brightgreen)]()
...
|-------|------|-------------|
| `ghcr.io/valqore/engine:latest` | **Free, public, tokenless** | All 1,431 rules, scoring, drift, billing, compliance, MCP, agent-gate |
